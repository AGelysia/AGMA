...
export interface StandaloneKnowledgeChunk {
...
export interface StandaloneKnowledgeSearchMatch {
  readonly documentId: string;
  readonly citation: string;
  readonly kind: StandaloneKnowledgeDocumentKind;
  readonly title: string;
...
export interface StandaloneKnowledgeSearchResult {
...
interface IndexedStandaloneChunk {
...
export class StandaloneKnowledgeIndex {
  readonly #chunks: readonly IndexedStandaloneChunk[];

  public constructor(chunks: readonly StandaloneKnowledgeChunk[] = []) {
  ...
  public search(rawQuery: string): StandaloneKnowledgeSearchResult {

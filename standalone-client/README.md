...
The `standalone-v0.3.2` release contains six runnable JARs. Choose the JAR matching Minecraft, mod
loader, and the operating system running the game:

| Minecraft | Loader | Java | Linux x86_64 | Windows x86_64 |
| --- | --- | --- | --- | --- |
| 1.21.11 | Fabric | 21+ | `AGMA-Client-Standalone-0.3.2-mc1.21.11-fabric-linux-x86_64.jar` | `AGMA-Client-Standalone-0.3.2-mc1.21.11-fabric-windows-x86_64.jar` |
| 1.18.2 | Fabric | 17+ | `AGMA-Client-Standalone-0.3.2-mc1.18.2-fabric-linux-x86_64.jar` | `AGMA-Client-Standalone-0.3.2-mc1.18.2-fabric-windows-x86_64.jar` |
| 1.18.2 | Forge | 17+ | `AGMA-Client-Standalone-0.3.2-mc1.18.2-forge-linux-x86_64.jar` | `AGMA-Client-Standalone-0.3.2-mc1.18.2-forge-windows-x86_64.jar` |

Every JAR contains the platform-specific Node.js 22.23.1 Runtime. A system Node installation is not
required. The other two release assets are `AGMA-Client-Standalone-0.3.2-SBOM.cdx.json` and
`AGMA-Client-Standalone-0.3.2-SHA256SUMS`; the checksum manifest covers all six JARs and the SBOM.

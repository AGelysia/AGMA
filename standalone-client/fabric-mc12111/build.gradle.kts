...
base {
    archivesName = "AGMA-Standalone-Client-mc1.21.11-fabric"
}
...
val minecraftVersion = libs.versions.minecraft12111.get()
val fabricApiVersion =
    libs.versions.fabric.api12111
        .get()
val loaderVersion =
...
dependencies {
    ...
    modCompileOnly(libs.jei.api12111)

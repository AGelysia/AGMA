...
final class ReflectiveLitematicaAdapter implements LitematicaAdapter {
  private static final Logger LOGGER = LoggerFactory.getLogger("agma-standalone-litematica");
  ...
  public synchronized LitematicaDisplayReport loadPreview(LitematicaPreviewRequest request) {
    ...
    try {
      ...
      schematic = bindings.schematicHolderGetOrLoad.invoke(holder, schematicFile.toFile());
      if (schematic == null) {
  ...
  private record Bindings(
    ...
    static Bindings link(ClassLoader classLoader, ApiClassNames names)
      ...
      return new Bindings(
          ...
          requireReturn(holder.getMethod("getOrLoad", java.io.File.class), schematic),
